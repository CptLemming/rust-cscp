...
use crate::cscp::{connection::Connection, models::{DB, AudioType, AudioWidth}};

use super::{frame::{Frame, Message, FrameAck, FrameError, FrameMessage}, requests::ClientRequest, models::{DeskInfo, Fader}};
...
impl CSCPClient {
  pub async fn connect<T: ToSocketAddrs>(addr: T, mut input_rx: mpsc::Receiver<ClientRequest>, fader_event_tx: mpsc::Sender<Fader>) -> Result<CSCPClient, Error> {
